...
1       if(khi-klo.gt.1) then
        ...
        !c1 = -0.00004d0
        !c2 = 4.518219d0
        ! Full Field Map CXLS Quad
        cc(1) = 3.729298295262422 
        cc(2) = 1.589061496533026
        cc(3) = 0.007270118472665  
        cc(4) = -0.001037528411732 
        cc(5) = -0.300960690497137  
        cc(6) = 0.126329208065095 
        cc(7) = 0.030365514753162 
        cc(8) = -0.014855833058677 
        ! Exponential Decay on CXLS Quad
        !cc(1) = 1.646565366457917 
        !cc(2) = 3.001159891694232
        !cc(3) = -2.547837620077324  
        !cc(4) = 1.881175822279825 
        !cc(5) = 0.775490562647986 
        !cc(6) = -0.237508960624897 
        !cc(7) = -0.018068940171247 
        !cc(8) = -0.092872505903291 
        
        bb = this%Param(2)
        dd = 2*this%Param(4)
        
        ! if effective length is 99, then quad is all fringe
        if(this%Param(3).eq.99) then
          !coordinate 0 points for Enge function.
          z10 = (this%Length)/2 !for entrance
